...
SCHEMAS: Dict[str, RowSchema] = {
    ...
    "core_attribute": {
        "cr0b4_person_id": lambda c: c["person_id"],
        "cr0b4_anniversary": lambda c: str(c["chunk"].get("anniversary")),
        ...
        "cr0b4_first_name": lambda c: str(c["chunk"].get("first_name")),
        "cr0b4_gender": lambda c: str(c["chunk"].get("gender")),
        "cr0b4_given_name": lambda c: str(c["chunk"].get("given_name")),
        "cr0b4_grade": lambda c: str(c["chunk"].get("grade")),
        "cr0b4_graduation_year": lambda c: str(c["chunk"].get("graduation_year")),
        "cr0b4_inactivated_at": lambda c: c["chunk"].get("inactivated_at"),
        "cr0b4_inactive_reason": lambda c: str(c["chunk"].get("inactive_reason")),
        "cr0b4_last_name": lambda c: str(c["chunk"].get("last_name")),
        "cr0b4_marital_status": lambda c: str(c["chunk"].get("marital_status")),
        "cr0b4_medical_notes": lambda c: str(c["chunk"].get("medical_notes")),
        "cr0b4_membership": lambda c: str(c["chunk"].get("membership")),
        "cr0b4_middle_name": lambda c: str(c["chunk"].get("middle_name")),
        "cr0b4_name": lambda c: str(c["chunk"].get("name")),
        "cr0b4_nickname": lambda c: str(c["chunk"].get("nickname")),
        "cr0b4_passed_background_check": lambda c: c["chunk"].get("passed_background_check"),
        "cr0b4_status": lambda c: str(c["chunk"].get("status")),
        "cr0b4_updated_at": lambda c: str(c["chunk"].get("updated_at")),
    },
