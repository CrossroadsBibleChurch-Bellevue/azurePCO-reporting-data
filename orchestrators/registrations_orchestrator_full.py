import time
from extractors.registrations_extractor_full import extraction
from database.loader import uploader
from database.prepper import wake_up_server


# This is the orchestrator for the Registrations endpoint, full refresh. As you can see, it isn't much.
